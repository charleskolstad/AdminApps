...
namespace AdminApps_Data
{
    public class DBCommands
    {
        ...
        public readonly static string _Connection = @"Data Source=DESKTOP-O4M7D2C\CHARLESSERVER;Initial Catalog=AdminApps;Integrated Security=True";
